...
export const DashboardPage: React.FC = () => {
  ...
  return <div className="space-y-7 max-w-6xl mx-auto">
    ...
    <Card className="p-5 bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-900"><h2 className="font-semibold">Know what your photo can tell you</h2><p className="text-sm mt-2">Check photo clarity and body-area suitability, then keep a record of your symptoms. A photo cannot establish your vitamin levels; discuss persistent concerns with a clinician.</p></Card>
